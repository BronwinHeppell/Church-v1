					...
					<div className="grid gap-12 xl:grid-cols-[21rem_minmax(0,1fr)] xl:gap-16">
						...
						<div className="xl:sticky xl:top-32 xl:self-start">
							...
							<Reveal kind="fade" delay={0.2}>
								<p className="text-muted mt-6 max-w-[36ch] text-[0.9375rem] leading-relaxed">
									Baptism, confirmation, marriage, membership and bereavement &mdash; how each works
									at Corpus Christi.
								</p>

								<div className="border-line mt-8 border-t pt-6">
									<p className="font-ui text-muted text-xs tracking-[0.14em] uppercase">
										Parish office
									</p>
									<p className="mt-3 flex flex-col gap-1 text-[0.9375rem]">
										<a href={PARISH.phoneHref} className="text-ink rule-link numerals self-start">
											{PARISH.phone}
										</a>
										<a
											href={`mailto:${PARISH.email}`}
											className="text-ink rule-link self-start break-words"
										>
											{PARISH.email}
										</a>
									</p>
