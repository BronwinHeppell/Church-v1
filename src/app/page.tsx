  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:description" content="Welcome to Corpus Christi Anglican Church, offering worship services, community outreach, and more in Garsfontein." />
        <meta property="og:image" content="/assets/hero.jpg" />
        <meta name="twitter:title" content="Corpus Christi Anglican Church" />
        <meta name="twitter:description" content="Welcome to Corpus Christi Anglican Church, offering worship services, community outreach, and more in Garsfontein." />
